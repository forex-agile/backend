...
public class PortfolioAssetTest {
	...
	public void setUp() {
		...
		user = new User(UUID.randomUUID(), "Demo User", "demo.user@email.com", "qwerty", currency, "demoaccount",
				new Role());
	...
	public void testSettersAndGetters() {
		...
		User newUser = new User(UUID.randomUUID(), "Demo User 2", "demo.user2@email.com", "asdf", currency,
